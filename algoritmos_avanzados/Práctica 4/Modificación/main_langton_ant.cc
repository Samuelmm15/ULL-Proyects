...
int main() {
   ...
   if (option_world == 1) {
      ...
      int ant_option = 0;
      cout << "Introduzca el tipo de hormiga del cual va ha hacer uso [[1] para la hormiga de langton, [2] para la hormiga de langton modificada]: ";
      cin >> ant_option;
      ...
      A.Ant_Generator(ant_list); 

      U.ant_universe(option_world, ant_option, F, I, A, V, ant_list); 
      exit(1);
