...
def Vernam_encryption(encrypt_message, response_op):    
    print()
    print(f"El mensaje es {encrypt_message}")
    ...
    print()
    print("¿Cómo prefiere generar la clave? [Manual(M)/Aleatoria(R)]: ")
    option = input()
    
    if (option == "M") | (option == "m"):
        Manual_key_production(binary_character, binary_character_united, response_op)
    elif (option == "R") | (option == "r"):
        Aleatory_key_production(encrypt_message, binary_character, response_op)
    else:
        print()
...
def Manual_key_production(binary_character, binary_character_united, response_op):
    ...
    print()
    print(f"El mensaje después de la operación en binario es {final_encrypt_message}")
    ...
    for x in encrypt_message_characters_list:
        encrypt_message_characters += str(x)
    print(f"Finalmente, el mensaje es {encrypt_message_characters}")
    
    if (response_op == "C") | (response_op == "c"):
        Menu(encrypt_message_binary,manual_key)
    else:
        Program_exit()
    
def Aleatory_key_production(encrypt_message, binary_character, response_op):
    ...
    for x in encrypt_message_binary:
        final_encrypt_message += str(x) # At this point the list united to print the encrypt message in binary
    print()
    print(f"El mensaje en binario es {final_encrypt_message}")
...
if __name__ == '__main__':
    print("¿Desea cifrar el mensaje o realizar un descifrado? [Cifrado(C)/Descifrado(D)]")
    option = input()
    ...
    if (option == "C") | (option == "c"):
        ...
        Vernam_encryption(encrypt_message, option)
    elif (option == "D") | (option == "d"):
        print()
        print("Introduzca el mensaje que quiere descifrar: ")
        encrypt_message = input()  
        Vernam_encryption(encrypt_message, option)
