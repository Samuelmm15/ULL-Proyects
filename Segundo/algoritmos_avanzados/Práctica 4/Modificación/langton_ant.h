...
class Ant { 
     ...
     * 
     */
    void Ant_Turn(list<Ant> &ant_list,int const ant_option, Finite_World &F, Infinite_World &I);
    /**
     * @brief The fuction that calculates the movement of the ant
     * 
     */
    void Ant_Move(list<Ant> &ant_list, int const ant_option, Finite_World &F, Infinite_World &I);
    public:
     ...
     * 
     */
    void Ant_Generator(list<Ant> &ant_list); 
    /**
     * @brief The fuction that changes the values of the Ant
     * 
     */
    void Ant_movement(list<Ant> &ant_list,int const ant_option, Finite_World &F, Infinite_World &I); 
    /**
     * @brief The fuction that represents the Ant
     * 
     */
    void Ant_Status_Representation(list<Ant> ant_list);
    /**
     * @brief Get the Turn object
     * 
     */
    void getTurn(list<Ant> &ant_list, int const ant_option, Finite_World &F, Infinite_World &I); 
    /**
     * @brief Get the Move object
     * 
     */
    void getMove(list<Ant> &ant_list, int const ant_option, Finite_World &F, Infinite_World &I);
};