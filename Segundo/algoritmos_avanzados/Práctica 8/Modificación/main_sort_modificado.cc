...
int main() {
    ...
    cout << "Si lo prefiere de manera manueal introduza [1], si lo prefiere aleatorio introduzca [2], y si prefiere aplicar la modificación introduzca [3]: ";
    cin >> write_option;
    ...
    if (write_option == 1) { /// Here starts the programm
        ...
        int auxiliary = 0;
        cells_size = 5000;
        cout << "Para comenzar se va a crear un vector de manera aleatoria, con valores entre 1 y 10000, y a su vez 5000 datos comparados" << endl;
        do {
            auxiliary = rand() % (range_max-range_min-1) + range_min;
            vector_sort.push_back(auxiliary);
            counter++;
        ...
        Vector_Sort_Selection<int>(vector_sort, cells_size); /// Ejecutamos los tres para obtener el contador
        cout << endl;
        cout << "El contador de comparaciones del algorimo de selección es: " << C.print() << endl;
        Vector_Sort_MergeSort<int>(vector_sort, cells_size);
        cout << endl;
        cout << "El contador de comparaciones del algoritmo MergeSort es: " << C.print() << endl;
        Vector_Sort_HeapSort<int>(vector_sort, cells_size);
        cout << endl;
        cout << "El contador de compraciones del algoritmo HeapSort es: " << C.print() << endl;
    }
    exit(1);
};