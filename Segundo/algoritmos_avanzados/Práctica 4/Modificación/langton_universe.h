...
class Universe {
     ...
     * 
     */
    void ant_universe(int const option_world, int const ant_option, Finite_World &F, Infinite_World &I, Ant &A, Vector_World<int> &V, list<Ant> &ant_list);
};