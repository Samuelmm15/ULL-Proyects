...
class Ant { 
     ...
     * 
     */
    void Ant_Turn(list<Ant> &ant_list, Finite_World &F, Infinite_World &I);
    /**
     * @brief The fuction that calculates the movement of the ant
     * 
     */
    void Ant_Move(list<Ant> &ant_list, Finite_World &F, Infinite_World &I);
    public:
     ...
     * 
     */
    void Ant_movement(list<Ant> &ant_list, Finite_World &F, Infinite_World &I); 
    /**
     ...
     * 
     */
    void getTurn(list<Ant> &ant_list, Finite_World &F, Infinite_World &I); 
    /**
     * @brief Get the Move object
     * 
     */
    void getMove(list<Ant> &ant_list, Finite_World &F, Infinite_World &I);
};