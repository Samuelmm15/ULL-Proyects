...
void World::Cell_Change() { 
   if (World::the_mesh[World::i_ant_coordinate][World::j_ant_coordinate] == " ") {  /// si la celda es O, hacemos la celda blanca y hacemos que la dirección cambie 180
   ...
   } else if (World::the_mesh[World::i_ant_coordinate][World::j_ant_coordinate] == "O") {
      World::the_mesh[World::i_ant_coordinate][World::j_ant_coordinate] = " ";
      if (World::ant_position == ">") {
            World::ant_position = "<";  
            World::i_ant_coordinate = World::i_ant_coordinate; 
