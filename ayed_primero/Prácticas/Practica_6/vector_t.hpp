...
public:
  ...
  void resize(const int); /// para volver a establecer el tamaño del vector
  
  // getters
  T get_val(const int) const; /// para obtener el valor del vector
  int get_size(void) const; /// para obtener el tamaño del vector
  
  // setters 
  void set_val(const int, const T); /// para establecer el valor del vector
  
  // getters-setters
  T& at(const int); /// para imprimir el vector por pantalla
...
private:
  ...
  void build(void); /// funcion para construir el vector
  void destroy(void); /// funcion para destruir el vector
};
